...
class SolarParseTest < Minitest::Test
  ...
  def test_saved_data
    ...
    html.gsub!(/2018\/12\/07/, Date.today.strftime('%Y/%m/%d')) # change update_date
    ...
    assert_equal 21941, summary.today_kwh
    ...
    assert_equal 65057019, summary.total_kwh
    ...
    assert_equal '22:49', summary.update_time

    assert_equal 789876, summary.sales
    ...
    assert_equal 838, solar.today_kwh
